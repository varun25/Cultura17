...
public class BeyondarFragmentSupport extends Fragment implements FpsUpdatable, OnClickListener,
	...
	private void checkIfSensorsAvailable() {
		...
		if (!compass && !accelerometer) {
			...
			dialog.setTitle("Looks like our app is too cool for your phone")
					.setMessage("Your phone does not have required hardware for Augmented Reality");
			dialog.show();
	 ...
	 * OnClickBeyondarObjectListener} to get notified when the user clickclick on a
